...
public class AvaliacaoListServlet extends BaseServlet {

    private final AvaliacaoService service = new AvaliacaoService();

    @Override
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        String stringEstabelecimento= req.getParameter("id_estabelecimento");
        try {
            ...
            List<Avaliacao> listaEstabelecimentos = service.buscarAvaliacoesPorEstabelecimento(idEstabelecimento);
            double media = service.calcularMedia(idEstabelecimento);

            req.setAttribute("avaliacoes", listaEstabelecimentos);
