...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a href="../paginas-principais/pagina-principal.html">Início</a></li>
    ...
    <main>
        <section class="welcome-section">
            ...
            <div class="quick-filters">
                <a href="../estabelecimentos/lista-estabelecimento.html" class="category-item">
        ...
        <section class="nearby-section">
            ...
            <div class="card-grid">
                    ...
                    <a href="../estabelecimentos/detalhe-estabelecimento.html" class="card">
                    <img src="../imgs/restaurante.jpeg" alt="Imagem do local">
                    <p>Nome do Estabelecimento</p></a>
    ...
    <footer>
        <p>Bora Beagá 2025 - Informática 2A</p>
    </footer>
