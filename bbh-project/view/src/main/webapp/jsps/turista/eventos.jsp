...
<main>
        ...
        <section class="eventos">
            ...
            %>
                <div class="evento">
                    ...
                    <form action="evento?action=delete" method="POST">
                        <input type="hidden" name="id" value="<%= e.getId() %>">
    ...
    <div id="modal" class="modal">
        <div class="modal-conteudo">
            ...
            <div class="evento-fakeimg grande"></div>

            <div class="modal-texto">
                <h3 id="modal-nome"></h3>
                <p id="modal-desc"></p>
                <a id="add-to-calendar-btn" class="modal-botao">Adicionar à Agenda</a>
            </div>
